...
contract StdChainsTest is Test {
    function testChainRpcInitialization() public {
        ...
        assertEq(getChain(31_337).rpcUrl, "http://127.0.0.1:8545");
    ...
    function testSetChainFirstFails() public {
        ...
        stdChainsMock.exposed_setChain("anvil2", ChainData("Anvil", 31_337, "URL"));
    }
    ...
    function testChainBubbleUp() public {
        ...
        stdChainsMock.exposed_setChain("needs_undefined_env_var", ChainData("", 123_456_789, ""));
        vm.expectRevert(
    ...
    function testCannotSetChain_ChainIdExists() public {
        ...
        stdChainsMock.exposed_setChain("custom_chain", ChainData("Custom Chain", 123_456_789, "https://custom.chain/"));

        vm.expectRevert('StdChains setChain(string,ChainData): Chain ID 123456789 already used by "custom_chain".');

        stdChainsMock.exposed_setChain("another_custom_chain", ChainData("", 123_456_789, ""));
    }

    function testSetChain() public {
        setChain("custom_chain", ChainData("Custom Chain", 123_456_789, "https://custom.chain/"));
        Chain memory customChain = getChain("custom_chain");
        assertEq(customChain.name, "Custom Chain");
        assertEq(customChain.chainId, 123_456_789);
        assertEq(customChain.chainAlias, "custom_chain");
        assertEq(customChain.rpcUrl, "https://custom.chain/");
        Chain memory chainById = getChain(123_456_789);
        ...
        customChain.chainId = 987_654_321;
        ...
        assertEq(anotherCustomChain.chainId, 987_654_321);
        ...
        chainById = getChain(123_456_789);
        assertEq(chainById.name, "Custom Chain");
        assertEq(chainById.chainId, 123_456_789);
    }
    ...
    function testSetNoEmptyAlias() public {
        ...
        stdChainsMock.exposed_setChain("", ChainData("", 123_456_789, ""));
    }
    ...
    function testSetChain_ExistingOne() public {
        ...
        setChain("custom_chain", ChainData("Custom Chain", 123_456_789, "https://custom.chain/"));
        assertEq(getChain(123_456_789).chainId, 123_456_789);

        setChain("custom_chain", ChainData("Modified Chain", 999_999_999, "https://modified.chain/"));
        vm.expectRevert("StdChains getChain(uint256): Chain with ID 123456789 not found.");
        stdChainsMock.exposed_getChain(123_456_789);

        Chain memory modifiedChain = getChain(999_999_999);
        assertEq(modifiedChain.name, "Modified Chain");
        assertEq(modifiedChain.chainId, 999_999_999);
    ...
    function testDontUseDefaultRpcUrl() public {
        ...
        stdChainsMock.exposed_getChain(31_337);
        vm.expectRevert(
