...
contract StdCheatsTest is Test {
    ...
    function testDealToken() public {
        ...
        deal(bar, address(this), 10_000e18);
        assertEq(barToken.balanceOf(address(this)), 10_000e18);
    }

    function testDealTokenAdjustTotalSupply() public {
        Bar barToken = new Bar();
        address bar = address(barToken);
        deal(bar, address(this), 10_000e18, true);
        assertEq(barToken.balanceOf(address(this)), 10_000e18);
        assertEq(barToken.totalSupply(), 20_000e18);
        deal(bar, address(this), 0, true);
        assertEq(barToken.balanceOf(address(this)), 0);
        assertEq(barToken.totalSupply(), 10_000e18);
    }

    function testDealERC1155Token() public {
        BarERC1155 barToken = new BarERC1155();
        address bar = address(barToken);
        dealERC1155(bar, address(this), 0, 10_000e18, false);
        assertEq(barToken.balanceOf(address(this), 0), 10_000e18);
    }

    function testDealERC1155TokenAdjustTotalSupply() public {
        BarERC1155 barToken = new BarERC1155();
        address bar = address(barToken);
        dealERC1155(bar, address(this), 0, 10_000e18, true);
        assertEq(barToken.balanceOf(address(this), 0), 10_000e18);
        assertEq(barToken.totalSupply(0), 20_000e18);
        dealERC1155(bar, address(this), 0, 0, true);
        assertEq(barToken.balanceOf(address(this), 0), 0);
        assertEq(barToken.totalSupply(0), 10_000e18);
    }
    ...
    function testBytesToUint() public {
        ...
        assertEq(29_625, bytesToUint_test(hex"73b9"));
    }
